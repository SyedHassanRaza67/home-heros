      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-secondary/60 to-background">
          <div className="container mx-auto max-w-3xl px-4 py-16 text-center">
            <h1 className="text-4xl font-bold tracking-tight md:text-5xl">Why trust HomeFix</h1>
            <p className="mt-4 text-lg text-muted-foreground">
              We built HomeFix so booking a home service in Pakistan feels as safe as ordering food online.
            </p>
          </div>
        </section>
