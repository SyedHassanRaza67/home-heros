...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Aram Karo" },
      { name: "description", content: "The terms that govern your use of Aram Karo services." },
      { property: "og:title", content: "Terms of Service — Aram Karo" },
      { property: "og:description", content: "Terms governing the use of Aram Karo." },
    ],
  }),
  component: TermsPage,
});
        ...
        <article className="container mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="prose-sm space-y-6 rounded-2xl border bg-card p-6 text-sm leading-relaxed md:text-base">
            <Section title="1. Acceptance of terms">
              By creating an account or booking a service through Aram Karo ("the platform"), you agree to these
              Terms of Service. If you do not agree, please don't use the platform.
            </Section>

            <Section title="2. Our service">
              Aram Karo connects customers in Pakistan with independent home-service professionals (electricians,
              AC technicians, and similar trades). Aram Karo is a marketplace — providers are not our employees.
            </Section>
            ...
            <Section title="5. Provider conduct">
              ...
              independent contractors. Aram Karo is not responsible for damages caused by a provider's conduct,
            ...
            <Section title="7. Limitation of liability">
              To the maximum extent permitted by law, Aram Karo is not liable for indirect, incidental, or
